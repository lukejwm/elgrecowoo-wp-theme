...
function adswth_blog_scripts()
{
    ...
    if (is_blog() || is_blog_search()) {
        ...
        wp_enqueue_script('adswth-js-search-post', ADSW_THEME_URL . '/blog/assets/js/search-post' . ADSW_THEME_MIN . '.js', ['jquery', 'elgrecowoo-js-handlebars', 'adswth-js-blog'], ADSW_THEME_VERSION, true);
...
function adswth_render_linked_products()
{
    ...
    <div class="options_group show_if_grouped">
        <p class="form-field">
            <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="adswth_linked_products"
                    name="adswth_linked_products[]"
