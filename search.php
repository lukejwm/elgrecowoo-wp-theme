...
<div class="container">
    ...
    <div id="content" class="content-area page-wrapper" role="main">
        ...
        <div class="searchH">
            <h5><?php _e( 'Search results for', 'elgrecowoo' ) ?>: <span><?php echo  get_search_query(); ?> (<?php echo $wp_query->found_posts; ?>)</span></h5>
        </div>
    ...
    <?php if (  $wp_query->max_num_pages > 1 ) { ?>
        ...
        <div class="load_more_cont">
            <span class="btn btn-blog btn-primary load_more"><?php _e('Load More Articles', 'elgrecowoo');?></span>
        </div>
