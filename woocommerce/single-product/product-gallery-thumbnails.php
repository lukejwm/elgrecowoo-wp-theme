        ...
        <div class="swiper-container product-main-slider-thumbs">
            <div class="swiper-wrapper">
                ...
                foreach ( $attachment_ids as $key => $attachment_id ) {
                    ...
                    echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<div class="swiper-slide"><a class="image-wrap"><div class="image-inner">%s</div></a></div>', $image ), $attachment_id, $post->ID, $image_class );
